...
<div class="bg_know">
	...
	<table class="registTable" summary="게시글 입력폼입니다.">
		...
		<tr>
			...
			<td>
				<input id="label_2" type="text" class="text" size="40" style="width:400px;" />
			</td>
		</tr>
		<tr>
			<th scope="row"><label for="label_3">보도일자</label></th>
			<td>
				<input id="label_3" type="text" class="text" size="10" style="width:100px;" />
		...
		<tr>
			...
			<td>
				<input id="label_4" type="text" class="text" size="40" style="width:400px;" />
			</td>
		</tr>
		<tr>
