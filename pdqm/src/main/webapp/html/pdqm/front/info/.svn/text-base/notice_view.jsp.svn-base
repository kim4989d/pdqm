...
<div class="bg_notice">
	...
	<div class="btnArea btn_ar">
		<a href="/pdqm/html/pdqm/front/info/notice_write.jsp"><img src="<c:url value='/images/pdqm/common/btn/btn_modify.gif'/>" alt="수정" /></a>
		<a href="##"><img src="<c:url value='/images/pdqm/common/btn/btn_del.gif'/>" alt="삭제" /></a>
		<a href="/pdqm/html/pdqm/front/info/notice.jsp"><img src="<c:url value='/images/pdqm/common/btn/btn_list.gif'/>" alt="목록" /></a>
	</div>
	<!--// 버튼영역 -->
