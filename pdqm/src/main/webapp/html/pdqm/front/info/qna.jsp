...
<div class="bg_qna">
	...
	<table class="tbType1" summary="번호, 제목, 게시시작일, 게시종료일, 작성자, 작성일, 조회수 입니다">
		...
		<tbody>
			<tr>
				<td>10</td>
				<td class="ta_l"><a href="/pdqm/html/pdqm/front/info/qna_view.jsp">글제목이  들어가는 자리</a> <img src="<c:url value='/images/pdqm/common/icon/icon_new.gif'/>" alt="new" /></td>
				<td>더미사용자</td>
				<td>2011.10.24</td>
			...
			<tr>
				<td>9</td>
				<td class="ta_l"><img src="<c:url value='/images/pdqm/common/icon/icon_re.gif'/>" alt="답글" /><a href="/pdqm/html/pdqm/front/info/qna_view.jsp">글제목이 들어가는 자리</a></td>
				<td>더미사용자</td>
				<td>2011.10.24</td>
				<td><img src="<c:url value='/images/pdqm/common/icon/icon_file.gif'/>" alt="첨부파일명넣기" /></td>
				<td>1</td>
			...
			<tr>
				<td>|</td>
				<td class="ta_l"><a href="/pdqm/html/pdqm/front/info/qna_view.jsp">글제목이 들어가는 자리</a></td>
				<td>더미사용자</td>
				<td>2011.10.24</td>
				<td><img src="<c:url value='/images/pdqm/common/icon/icon_file.gif'/>" alt="첨부파일명넣기" /></td>
				<td>1</td>
	...
	<div class="pagenate_btn">
		...
		<div class="btn_pr">
			<a href="/pdqm/html/pdqm/front/info/qna_write.jsp"><img src="<c:url value='/images/pdqm/common/btn/btn_write.gif'/>" alt="글쓰기" /></a>
		</div>
	</div>
	<!--// pading_Btn -->
	...
	<fieldset class="searchBox">
		...
		<input name="searchWrd" type="text" size="35" value='' maxlength="35" style="width:155px;" title="검색어 입력" />
