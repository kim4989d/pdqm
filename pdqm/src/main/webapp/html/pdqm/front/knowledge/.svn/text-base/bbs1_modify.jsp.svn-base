...
<%
  ...
  * @Description : 지식자료실, 교육/공지안내, 교육자료실, 협의회 커뮤니티, 공지사항, 묻고답하기 수정화면
  *
  */
%>
...
<div class="bg_know">
	...
	<table class="registTable" summary="게시글 입력폼입니다.">
		...
		<tr>
			...
			<td>
				<input id="nttSj" type="text" class="text" style="width:600px;" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<!-- 에디터 들어가는 자리 -->
				<textarea id="nttCn" class="text" cols="75" rows="28" style="width:600px;height:200px;"></textarea>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<ul>
					<li>2011년 품질진단·개선 사업 우수사례.pdf <input type="button" value="삭제" class="sbtn_close" /></li>
					<li>2011년 품질진단·개선 사업 우수사례.pdf <input type="button" value="삭제" class="sbtn_close" /></li>
				</ul>
			</td>
		</tr>
