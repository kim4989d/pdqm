...
<div class="bg_know">
	...
	<table class="registTable" summary="게시글 입력폼입니다.">
		...
		<tr>
			...
			<td>
				<input id="nttSj" type="text" size="60" value="" maxlength="60" style="width:500px;" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input id="label_2" type="text" class="text" size="40" value="" style="width:400px;" />
			</td>
		</tr>
		<tr>
			<th scope="row"><label for="label_3">보도일자</label></th>
			<td>
				<input id="label_3" type="text" class="text" size="10" value="" style="width:100px;" />
		...
		<tr>
			...
			<td>
				<input id="label_4" type="text" class="text" size="40" value="" style="width:400px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<!-- 에디터 들어가는 자리 -->
				<textarea name="nttCn" class="text" cols="75" rows="28" style="width:580px;height:200px;"></textarea>
			</td>
		</tr>
	</table>
