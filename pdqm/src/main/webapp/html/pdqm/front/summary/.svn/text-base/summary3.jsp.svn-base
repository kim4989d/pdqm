...
<div class="bg_sum">
	<div class="title">
		...
		<p class="h3_desc"><img src="<c:url value='/images/pdqm/front/summary/h3_sum3_desc.png'/>" class="png24" alt="공공정보 품질관리의" longdesc="#h3_sum3_desc"/>
			<span id="h3_sum3_desc" class="hide">표준인 행정표준코드관리시스템, 행정데이터관리시스템을 소개합니다. 각 표준은 행정기관간 행정정보의 원활한 공동이용을 위하여 수립되었습니다. 더 상세한 내용은 행정표준코드 시스템 홈페이지(https://www.code.go.kr) 와 행정데이터관리 시스템 홈페이지(https://www.adams.go.kr)를 확인하세요.</span>
		</p>
	</div>
			...
			<ul>
				...
				<li><a href="#header" class="sum3_tab1">행정표준코드</a>
					<div class="tab_conTxt">
						...
						<p><img src="<c:url value='/images/pdqm/front/summary/img_sum3_box1.gif'/>" alt="각급 행정기관에서" longdesc="#img_sum3_box1" />
							<span id="img_sum3_box1" class="hide">행정표준코드의 제·개정(안) 작성, 소관부처에서 행정표준코드의 제·개정(안) 접수 및 검토, 기술적 사항 및 코드변경관리방법 사전 협의, 행정표준코드의 제·개정(안)을 제출합니다.</span>
						</p>
				...
				<li><a href="#header" class="sum3_tab2">행정정보DB표준화</a>
					<div class="tab_conTxt">
						...
						<h4><img src="<c:url value='/images/pdqm/front/summary/h4_sum3_3.gif'/>" alt="첨부파일" /></h4>
						<table class="conTable2" summary="첨부파일 테이블입니다.">
							<caption>행정정보DB표준화 첨부파일</caption>
							<colgroup>
								<col width="20%"><col width="auto">
							</colgroup>
							<tr>
								<th>첨부파일</th>
								<td>
									<a href="##"><img src="<c:url value='/images/pdqm/common/icon/icon_pdf.gif'/>" alt="pdf 파일" /> 행정정보데이터베이스표준화지침.pdf</a> (용량 : 234KB)<br />
									<a href="##"><img src="<c:url value='/images/pdqm/common/icon/icon_pdf.gif'/>" alt="pdf 파일" /> 공공정보 데이터베이스 품질관리 지침 해설서.pdf</a>  (용량 : 850KB)
								</td>
							</tr>
						</table>
