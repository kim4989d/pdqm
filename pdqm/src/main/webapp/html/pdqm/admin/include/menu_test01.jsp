...
<script>
	...
	function fn_load_menu(menu) {
		document.adminform.targer = "ifrm";
		document.adminform.action = menu;
...
<div id="wrapper">
	...
	<div id="cntWrap">
		...
		<div id="cntArea">
		<form name="adminform">
		<iframe id="ifrm" name="ifrm" src="" width="750" height="800" scrolling="auto">
		</iframe>
		</form>
	...
	<div id="exam2">
		<ul>
			<li class="menu">
				<a href="${pageContext.request.contextPath}/uss/umt/EgovMberManage.do" onclick="javascript:fn_load_menu(this.href); return false;">회원정보조회</a>
				<ul class="hide">
					<li>메뉴1-1</li>
					<li>메뉴1-2</li>
					<li>메뉴1-3</li>
