...
<%
 /**
  * @Class Name : p18.jsp
  * @Description : 관리수준 자가진단 결과 점수 조회/수정
  *
  */
%>
</head>
...
<!-- contents: Start -->
	<div class="title">
		<div class="locationMap">품질수준 자가진단관리 > 관리수준 자가진단 결과 점수 조회/수정</div>
		<h2>관리수준 자가진단 결과 점수 조회/수정</h2>
	</div>
		...
		<tr>
			...
			<td>
				<select id="search1" name="search1" class="text">
					...
					<option value="1" selected="selected">등록된 진단대상</option>
				</select>
			</td>
			...
			<td>
				<select id="search2" name="search2" class="text">
					<option value="0">전체</option>
					<option value="1" selected="selected">등록된 진단관점</option>
				</select>
			</td>
		</tr>
	</table>
	...
	<!-- listTable: Start -->
	<table class="tblType1 tblSpace" summary="관리수준 자가진단 결과 점수 조회/수정 테이블입니다.">
		<colgroup>
			<col width="20%" />
			<col width="20%" />
			<col width="20%" />
