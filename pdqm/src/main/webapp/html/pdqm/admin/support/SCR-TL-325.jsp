...
<!-- contents: Start -->
	<div class="title">
		<div class="locationMap">특성 등록</div>
		<h2>특성 등록</h2>
	</div>

	<div class="ov_h">
		<div class="leftArea">
			<table class="tblType1" summary="특성 등록 테이블입니다.">
				<colgroup>
					<col width="30%" />
					<col width="auto"/>
				</colgroup>
		...
		<div class="rightArea">
			<fieldset>
			<legend>특성 등록</legend>
				<table class="vblType1" summary="특성 등록 테이블입니다.">
					<colgroup>
						<col width="30%" />
						<col width="auto"/>
					</colgroup>
					<tr>
						...
						<td>
							<select id="no7" name="no7" class="text">
								<option selected="selected">완전성</option>
							</select>
						</td>
					</tr>
					<tr>
						<th><label for="no8">특성명</label></th>
						<td><input type="text" id="no8" name="no8" value="물리" class="text" style="width:320px;" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" id="no11" name="no11" value="" class="text" style="width:320px;" /></td>
					</tr>
					<tr>
