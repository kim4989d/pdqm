...
<%
 /**
  * @Class Name : SCR-TL-SELF-M0040.jsp
  * @Description :  관리수준 자가진단 문항 관리 화면
  *
  */
%>
...
<!-- contents: Start -->
	<div class="title">
		<div class="locationMap">Home > 품질수준 자가진단관리 > 관리수준 자가진단 > 관리수준 문항관리</div>
		<h2>관리수준 자가진단 문항 관리</h2>
	</div>

	<div class="tab list jx">
		<ul>
			<li>
				<a href="#"><span>값(10)</span></a>
				<dl>
					<dt>활용(2)
						<span class="q_btn">
