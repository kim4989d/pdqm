...
function fnOpen()
{
	...
	// 필수 - 레포트 파일명
	oReport.rptname = "samples/oracle_emp";
	...
	*/
	...
	//        oArgs : 이벤트 파라메터(finishexport - filename, hyperlinkclicked - Path)
	//-----------------------------------------------------------------------------------------------
...
<body>
	...
	<iframe name="ifrmRexPreview1" id="ifrmRexPreview1" src='rexpreview.jsp' width="800" height="400"></iframe>
