...
//	var url = "/sym/cal/EgovAdministCalPopup.do";
	...
	// FIREFOX
	var openParam = "dialogWidth:320px;dialogHeight:250px;scroll:no;status:no;center:yes;resizable:yes;";
...
//	var url = "/sym/cal/EgovNormalCalPopup.do";
	...
	if( sAppName.indexOf("Netscape") > -1){
		openParam = "dialogWidth:320px;dialogHeight:250px;scroll:no;status:no;center:yes;resizable:yes;";
...
// 달력선택시 연월값 리턴 psh
function fnYearMonthCalendar(frm, sDate) {
	var retVal;
	...
	if(retVal) {
		sDate.value = retVal.vDate.substring(0,7);
	}
}
