...
<table width="90%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="추천사이트 정보테이블">
  ...
  <tr>
    ...
    <td width="80%" nowrap>
      <textarea name="recomendSiteDc" id="recomendSiteDc" class="textarea"  cols="300" rows="10"  style="width:450px;"  readonly><c:out value="${result.recomendSiteDc}"/>
      </textarea>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td width="80%" nowrap>
      <textarea name="recomendResnCn" id="recomendResnCn" class="textarea"  cols="300" rows="5"  style="width:450px;"   readonly><c:out value="${result.recomendResnCn}"/>
      </textarea>
