...
<div id="border" style="width:730px">
	<table width="100%" cellpadding="8" class="table-search" border="0"  summary="게시판명, 커뮤니티 동호회 정보  입니다">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>
	  		<img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;게시판 사용등록
	  	</h1>
	  </td>
	 </tr>
	</table>
	...
	<tr>
	  ...
	  <td><span class="button"><input type="submit" value="<spring:message code="button.create" />" onclick="fn_egov_regist_bbsUseInf(); return false;"></span></td>
