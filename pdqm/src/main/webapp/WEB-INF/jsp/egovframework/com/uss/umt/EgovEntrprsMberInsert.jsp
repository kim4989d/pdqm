...
<!-- content start -->
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle" alt="" />&nbsp;기업회원 등록</td>
            </tr>
        </table>
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    기업회원아이디<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="" />
                </th>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    회사명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="" />
                </th>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    비밀번호<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="" />
                </th>
                <td width="80%" nowrap><label for="entrprsMberPassword"/>
                    <form:password path="entrprsMberPassword" id="entrprsMberPassword" size="20" maxlength="20"  />
                    <div><form:errors path="entrprsMberPassword" cssClass="error"/></div>
                </td>
            </tr>
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    비밀번호확인<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="" />
                </th>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    사업자등록번호<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="" />
                </th>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    회사전화번호<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="" />
                </th>
                <td width="80%" nowrap><label for="areaNo"/>
                    <form:input path="areaNo" id="areaNo" cssClass="txaIpUmt" size="5" maxlength="20" />
                    - <label for="entrprsMiddleTelno"/><form:input path="entrprsMiddleTelno" id="entrprsMiddleTelno" cssClass="txaIpUmt" size="5" maxlength="100" />
                    - <label for="entrprsEndTelno"/><form:input path="entrprsEndTelno" id="entrprsEndTelno" cssClass="txaIpUmt" size="5" maxlength="5" />
            ...
            <tr>
                ...
                <td width="80%" nowrap><label for="adres"/>
                    <form:input path="adres" id="adres" cssClass="txaIpUmt" size="70" maxlength="50" readonly="true" />
            ...
            <tr>
                ...
                <td width="80%" nowrap><label for="detailAdres"/>
                    <form:input path="detailAdres" id="detailAdres" cssClass="txaIpUmt" size="70"  maxlength="50" />
                </td>
            </tr>
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    신청자이름<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="" />
                </th>
                <td width="80%" nowrap><label for="applcntNm"/>
                    <form:input path="applcntNm" id="applcntNm" cssClass="txaIpUmt" size="20" maxlength="20" />
                    <div><form:errors path="applcntNm" cssClass="error"/></div>
                </td>
            </tr>
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    신청자이메일주소<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="" />
                </th>
                <td width="80%" nowrap><label for="applcntEmailAdres"/>
                    <form:input path="applcntEmailAdres" id="applcntEmailAdres" cssClass="txaIpUmt" size="20" maxlength="20" />
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    기업회원상태코드<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="" />
                </th>
