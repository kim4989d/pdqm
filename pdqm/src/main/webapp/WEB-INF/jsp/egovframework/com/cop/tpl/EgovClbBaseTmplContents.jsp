					...
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100%" style="background-image : url(${pageContext.request.contextPath}/images/egovframework/com/cop/tpl/right_gap.gif);" ><img src="<c:url value='/images/egovframework/com/cop/tpl/right_gap.gif' />" width="9" height="9" alt="gap" ></td>
								<td><img src="<c:url value='/images/egovframework/com/cop/tpl/right_gap.gif' />" width="9" height="9" alt="gap" /></td>
							</tr>
							<tr>
								<td height="9" style="background-image : url(${pageContext.request.contextPath}/images/egovframework/com/cop/tpl/right_gap.gif);"><img src="<c:url value='/images/egovframework/com/cop/tpl/right_gap.gif' />" width="9" height="9" alt="gap" /></td>
