...
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="변경처리내역 ">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="processDe">변경처리일자</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수"></th>
    <td width="80%" nowrap>&nbsp;
	  ...
	  <img name="calendarImg" src="<c:url value='/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" alt='달력'></a>
    </td>
  </tr>
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="opetrId">변경처리자</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수"></th>
    <td width="80%" nowrap>
      &nbsp; 
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="processSttus">변경처리상태</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수"></th>
    <td width="80%" nowrap>&nbsp; 
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="<c:url value='/images/egovframework/com/sym/prm/icon/tit_icon_pop.gif' />" width="16" height="16" hspace="3" alt="" />&nbsp;변경요청내역</label></td>
 </tr>
</table>
...
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="변경요청내역 ">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterNo">요청번호</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" /></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="progrmFileNm">프로그램파일명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" /></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterPersonId">요청자ID</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" /></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterDe">요청일자</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" /></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterSj">요청제목</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" /></th>
    <td width="80%" nowrap>
