...
<input type="hidden" name="searchCnd" value ="0" >
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  ...
	  <td width="40%">	 
	    <input name="searchWrd" type="text" size="35" value="<c:out value="${searchVO.searchWrd}"/>" maxlength="35" onkeypress="press(event);" style="width: 200px">
	...
	<table width="100%" cellpadding="8" class="table-line" summary="바로가기메뉴관리 목록조회">
	 <thead>
	  <tr>	    
	    <th class="title" width="5%" nowrap><input type="checkbox" name="all_check" class="check2" onclick = "javascript:fCheckAll();"></th>	    
	 ...
	 <tbody>
		 <c:forEach var="result" items="${resultList}" varStatus="status">
		  <tr>
		    ...
		    <td class="lt_text3" nowrap><input type="checkbox" name="check1" class="check2">
