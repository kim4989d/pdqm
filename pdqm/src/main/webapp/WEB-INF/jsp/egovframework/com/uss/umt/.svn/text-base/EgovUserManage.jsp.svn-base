...
<body>
        ...
        <table border="0" cellspacing="0" cellpadding="0" summary="조회 기능을 제공한다.">
            <tr>
                ...
                <select name="sbscrbSttus" id="sbscrbSttus" title="검색조건1">
                ...
                <select name="searchCondition" id="searchCondition" title="검색조건2">
                ...
                <input name="searchKeyword" type="text" value="<c:out value="${userSearchVO.searchKeyword}"/>" title="검색" />
                </div>
                </td>
                <td>&nbsp;</td>
                <td>
