...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left"><h1 class="title_left">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목">&nbsp;휴일 등록</h1></td>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<CAPTION style="display: none;">휴일 등록</CAPTION>
  <tr> 
    <th scope="row" width="20%" height="23" class="required_text" nowrap >휴일일자<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" alt="필수"  width="15" height="15"  style="vertical-align: middle"></th>
    <td width="80%" nowrap>
		...
		<a href="#noscript" onclick="fn_egov_NormalCalendar(document.restde, document.restde.restdeDe, document.restde.vrestdeDe); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력(새창)"></a>
   	</td>
  </tr>
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap >휴일명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" alt="필수"  width="15" height="15"></th>          
    <td width="80%" nowrap>
  ...
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap >휴일설명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" alt="필수"  width="15" height="15"></th>          
    <td>
  ...
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap >휴일구분<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" alt="필수"  width="15" height="15"></th>          
    <td width="80%" nowrap>    
