...
<input type="hidden" name="tmplatId" value="" />
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	  	<h1>			
	  		<img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;템플릿 목록
	  	</h1>
	  </td>
	  <th >
	  </th>
	  ...
	  <th width="10%">
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr> 
	      <td><img src="${ImgUrl}btn/bu2_left.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
	      ...
	      <td><img src="${ImgUrl}btn/bu2_right.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
	    </tr>
	   </table>
	  </th>  
	 </tr>
	...
	<tr> 
		<td><img src="<c:out value="${ImgUrl}" />button/bu2_left.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
