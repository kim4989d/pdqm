...
<div id="border" style="width:730px">
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>		
	  		<img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle" alt="">&nbsp;템플릿 정보등록
	  	</h1>
	  </td>
	 </tr>
	</table>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr> 
	    <td>
            <div align="right">
              <span class="button"><input type="submit" value="등록" onclick="fn_egov_regist_tmplatInfo(); return false;"></span>
            </div>
        </td>
	    <td>
	    	&nbsp;
	    ...
	    <td width="5%" align="center">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                    ...
                    <td class="btnBackground" nowrap><a href="<c:url value='/cop/tpl/selectTemplateInfs.do'/>" alt="목록" >목록</a></td>
