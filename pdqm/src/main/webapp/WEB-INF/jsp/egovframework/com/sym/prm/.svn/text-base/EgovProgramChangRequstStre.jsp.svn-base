...
<form:form commandName="progrmManageDtlVO"  action ="<c:url value='/sym/prm/EgovProgramChangRequstStre.do'/>" method="post">
...
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register"   summary="프로그램변경요청 ">
  ...
  <tr> 
    <th width="145" height="23" class="required_text" scope="row"><label for="rqesterNo">요청번호</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" /></th>
    <td width="527" nowrap>&nbsp;
  ...
  <tr> 
    <th width="145" height="23" class="required_text" scope="row"><label for="progrmFileNm">프로그램파일명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" /></th>
    <td width="527" nowrap>&nbsp; 
    	<input id="progrmFileNm" name="progrmFileNm" size="50"  maxlength="50"  title="프로그램파일명" readonly/>
	    <form:errors path="progrmFileNm" />
        <a href="<c:url value='/sym/prm/EgovProgramListSearch.do'/>?tmp_SearchElementName=progrmFileNm" target="_blank" title="새창으로" onclick="javascript:searchFileNm(); return false;" style="selector-dummy:expression(this.hideFocus=false);"  title="새 창으로 이동">
        <img src="<c:url value='/images/egovframework/com/cmm/search2.gif' />" alt='(프로그램파일명 검색)' width="15" height="15" />(프로그램파일명 검색)</a>
    </td>
  </tr>
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterPersonId">요청자</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" /></th>
    <td width="80%" nowrap>&nbsp;
  ...
  <tr> 
    ...
    <td width="80%" nowrap>&nbsp; 
      ...
      <a href="#LINK" onClick="javascript:fn_egov_NormalCalendar(progrmManageDtlVO,'', progrmManageDtlVO.rqesterDe); return false;" style="selector-dummy:expression(this.hideFocus=false);">
