...
<tr>       
  <th scope="row">&nbsp;</th>
  <td><img src="/images/egovframework/com/cmm/uss/umt/button/bu2_left.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
  ...
  <td><img src="/images/egovframework/com/cmm/uss/umt/button/bu2_right.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
...
<%
	...
	if(fileLogPattrn != null){ try{fileLogPattrn=null;}catch(Exception e){} }
