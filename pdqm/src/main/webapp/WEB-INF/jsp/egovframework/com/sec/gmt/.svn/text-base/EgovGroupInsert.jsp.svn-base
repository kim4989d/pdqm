...
<table width="100%" cellpadding="8" class="table-line" summary="그룹을 등록하는 테이블입니다.그룹 ID,그룹 명,설명,등록일자의 정보를 담고 있습니다.">
  <!--<tr>
    <th class="required_text" width="25%" scope="row" nowrap="nowrap">그룹 ID<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수"></th>
    <td nowrap="nowrap"><input name="groupId" id="groupId" type="text" value="<c:out value='${groupManage.groupId}'/>" size="40" title="그룹 ID"/></td>
  </tr>
  --><tr>    
    <th class="required_text" width="25%" scope="row" nowrap="nowrap">그룹 명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수"></th>
