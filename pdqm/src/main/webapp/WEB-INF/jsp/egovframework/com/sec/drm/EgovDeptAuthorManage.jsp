...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="25%" class="title_left">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="화살표">&nbsp;부서 권한 관리</td>
  <td width="55%">부서<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수"> : <input name="deptCode" type="text" value="<c:out value='${deptAuthorVO.deptCode}' />" size="22" title="부서코드" onkeypress="press();" readOnly />
