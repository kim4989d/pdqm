...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="20%" class="title_left">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="화살표">&nbsp;권한 그룹 관리</td>
  <td width="50%">조회조건 : <select name="searchCondition" onchange="onSearchCondition()" title="조회조건">
...
<table width="100%" cellpadding="8" class="table-line" summary="권한 그룹을 관리하는 테이블입니다.사용자 ID,사용자 명,사용자 유형,권한,등록 여부의 정보를 담고 있습니다.">
 <thead>
  <tr>
    <th class="title" width="5%" scope="col" nowrap="nowrap"><input type="checkbox" name="checkAll" class="check2" onclick="javascript:fncCheckAll()"></th>
