...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="20%"class="title_left">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;부서 관리</td>
  <td width="60%">부서 명 : <input name="searchKeyword" type="text" value="<c:out value="${deptManageVO.searchKeyword}"/>" size="25" title="검색" onkeypress="press();" ></td>
