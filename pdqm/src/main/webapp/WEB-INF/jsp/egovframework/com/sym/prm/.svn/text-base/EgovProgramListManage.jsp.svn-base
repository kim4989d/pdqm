...
<table width="791" border="0" cellpadding="0" cellspacing="1">
 <tr>
  <td width="100%">
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="프로그램목록관리 검색조건">
   	<caption>프로그램목록관리</caption>
      <tr>
        <th width="20%" height="40" class="" scope="row"><label for="searchKeyword">프로그램명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수"></th>
        <td width="80%">
...
<table width="717" cellpadding="8" cellpadding="0" class="table-line" style="table-layout:fixed" summary="프로그램목록관리 목록으로 프로그램파일명, 프로그램명, url,프로그램설명 으로 구성">
