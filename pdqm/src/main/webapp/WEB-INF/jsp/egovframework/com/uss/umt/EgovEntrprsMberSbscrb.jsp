...
<!-- content start -->
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle">&nbsp;기업회원 가입신청</td>
            </tr>
        </table>
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    기업회원아이디<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15">
                </th>
                <td width="80%" nowrap>
                    <form:input path="entrprsmberId" size="20" cssClass="txaIpUmt" readonly="true" maxlength="20" />
                    <a href="javascript:fnIdCheck();">
                        <img align="absmiddle" src="<c:url value='/images/egovframework/com/cmm/icon/search.gif' />">(중복아이디 검색)
                    </a>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    회사명<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15">
                </th>
                <td width="80%" nowrap>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    비밀번호<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15">
                </th>
                <td width="80%" nowrap>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    비밀번호확인<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15">
                </th>
                <td width="80%" nowrap>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    비밀번호힌트<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15">
                </th>
                <td width="80%" nowrap>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    비밀번호정답<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15">
                </th>
                <td width="80%" nowrap>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    사업자등록번호<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15">
                </th>
                <td width="80%" nowrap>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    회사전화번호<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15">
                </th>
                <td width="80%" nowrap>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    우편번호<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15">
                </th>
                <td width="80%" nowrap>
                    ...
                    <form:hidden path="zip" />
                        <a href="javascript:fn_egov_ZipSearch(document.entrprsManageVO, document.entrprsManageVO.zip, document.entrprsManageVO.zip_view, document.entrprsManageVO.adres);">
                            <img src="<c:url value='/images/egovframework/com/cmm/icon/search.gif' />">(우편번호 검색)
                        </a>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    주소<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15"></th>
                <td width="80%" nowrap>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    신청자이름<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15">
                </th>
                <td width="80%" nowrap>
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    신청자이메일주소<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15">
                </th>
                <td width="80%" nowrap>
            ...
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0" align="center">
		            <tr>
		                ...
		                <td><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_right.gif' />" width="8" height="20"></td>
		                <td>&nbsp;</td>
		                <td><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_left.gif' />" width="8" height="20"></td>
		                <td background="<c:url value='/images/egovframework/com/cmm/btn/bu2_bg.gif' />" class="text_left" nowrap>
