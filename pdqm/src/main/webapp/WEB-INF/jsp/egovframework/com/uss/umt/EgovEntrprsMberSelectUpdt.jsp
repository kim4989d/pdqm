        ...
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            <tr>
                ...
                <td width="80%" nowrap><label for="entrprsmberId"/>
                    <form:input path="entrprsmberId" id="entrprsmberId" size="20" cssClass="txaIpUmt" readonly="true" maxlength="20" />
            ...
            <tr>
                ...
                <td width="80%" nowrap><label for="cmpnyNm"/>
                    ...
                    <form:input path="cmpnyNm" id="cmpnyNm" size="45" cssClass="txaIpUmt" readonly="false" maxlength="50" />
            ...
            <tr>
                ...
                <td width="80%" nowrap>
                    <label for="areaNo"/><form:input path="areaNo" id="areaNo" cssClass="txaIpUmt" size="5" maxlength="20" />
