  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
			...
			<!-- 게시판 목록 부분 : End -->
              ...
              <tr>
                <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="21"><img src="<c:url value='/images/egovframework/com/cop/tpl/1_step_left.gif' />" width="21" height="23" alt="left menu" /></td>
                    <td align="left" background="<c:url value='/images/egovframework/com/cop/tpl/1_step_bg.gif' />" class="f_step">동호회 목록</td>
                    <td width="6"><img src="<c:url value='/images/egovframework/com/cop/tpl/1_step_right.gif' />" width="6" height="23" alt="left menu" /></td>
                  </tr>
                </table></td>
              </tr>
        ...
        <c:otherwise>
        	<!--  컨텐츠 영역 : Start -->
			<iframe id="contentFrame" onload="javascript:calcHeight();" src="<c:url value='/cop/cmy/CmmntyMainContents.do'/>?cmmntyId=<c:out value='${cmmntyVO.cmmntyId}' />" frameborder="0" width="758" height="480"></iframe>
        	<!--  컨텐츠 영역 : End -->
        </c:otherwise>
        </c:choose>
          <br />
