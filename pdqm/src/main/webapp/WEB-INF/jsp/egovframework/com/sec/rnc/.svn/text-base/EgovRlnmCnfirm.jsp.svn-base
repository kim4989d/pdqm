...
<!-- content start -->
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle">&nbsp;주민등록 실명확인</td>
            </tr>
        </table>
        <table width="717" border="0"  cellspacing="0" cellpadding="0">
            <tr>
	            <td>
	                &nbsp;이름:<input type="text" name="realname" value="${realname}">
	                &nbsp;주민등록번호 <input tyep="text" name="ihidnum" value="${ihidnum}">(-없이 13자리)
