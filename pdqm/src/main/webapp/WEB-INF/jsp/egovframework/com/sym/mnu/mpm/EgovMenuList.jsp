 ...
 <tr>
   ...
   <td width="70%" class="title_left">
	...
	<caption>메뉴리스트정보 </caption>
		  <tr>
		    <th width="30%" height="23" class="required_text"  scope="row"><label for="menuNo">메뉴No</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" ></th>
		    <td width="70%" nowrap>
		      &nbsp;
		  ...
		  <tr>
		    <th width="30%" height="23" class="required_text"  scope="row"><label for="menuOrdr">메뉴순서</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" ></th>
		    <td width="70%" nowrap>
		      &nbsp; <input name="menuOrdr" type="text" size="10" value=""  maxlength="10" title="메뉴순서">
		    </td>
		  </tr>
		  <tr>
		    <th width="30%" height="23" class="required_text"  scope="row"><label for="menuNm">메뉴명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" ></th>
		    <td width="70%" nowrap>
		      &nbsp; <input name="menuNm" type="text" size="30" value=""  maxlength="30" title="메뉴명">
		    </td>
		  </tr>
		  <tr>
		    <th width="30%" height="23" class="required_text"  scope="row"><label for="upperMenuId">상위메뉴No</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" ></th>
		    <td width="70%" nowrap>&nbsp;
		    <input name="upperMenuId" type="text" size="10" value=""  maxlength="10" title="상위메뉴No">
	        <a href="/sym/mnu/mpm/EgovMenuListSelectMvmn.do" target="_blank" title="새창으로" onClick="mvmnMenuList();return false;"  style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/cmm/search2.gif' />"
	         alt='' width="15" height="15" />(메뉴선택 검색)</a>
		    </td>
		  </tr>
		  <tr>
		    <th width="30%" height="23" class="required_text"  scope="row"><label for="progrmFileNm">파일명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" ></th>
		    <td width="70%" nowrap>
	        &nbsp;
	        <input name="progrmFileNm" type="text" size="30" value=""  maxlength="60" title="파일명">
	        <a href="/sym/prm/EgovProgramListSearch.do" target="_blank" title="새창으로" onClick="searchFileNm();return false;"  style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/cmm/search2.gif' />"
	         alt='' width="15" height="15" />(프로그램파일명 검색)</a>
		    </td>
		  </tr>
		  <tr>
		    <th width="30%" height="23" class="required_text"  scope="row"><label for="relateImageNm">관련이미지명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" ></th>
		    <td width="70%" nowrap>
		      &nbsp; <input name="relateImageNm" type="text" size="30" value=""  maxlength="30" title="관련이미지명">
		    </td>
		  </tr>
		  <tr>
		    <th width="30%" height="23" class="required_text"  scope="row"><label for="relateImagePath">관련이미지경로</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수" ></th>
		    <td width="70%" nowrap>
