...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="90%" class="title_left">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;부서 수정
  </td>
 </tr>
</table>
...
<table width="100%" cellpadding="8" class="table-line">
  <tr>
    ...
    <td class="lt_text" nowrap><input name="orgnztId" id="orgnztId" type="text" value="<c:out value='${deptManage.orgnztId}'/>" size="30" class="readOnlyClass" readonly></td>
  </tr>
  <tr>
    ...
    <td class="lt_text" nowrap>
        <input name="orgnztNm" id="orgnztNm" type="text" value="<c:out value='${deptManage.orgnztNm}'/>" maxLength="10" size="30" >&nbsp;<form:errors path="orgnztNm" /></td>
  </tr>
  <tr>
    ...
    <td class="lt_text" nowrap><input name="orgnztDc" id="orgnztDc" type="text" value="<c:out value='${deptManage.orgnztDc}'/>" maxLength="255" size="50" >&nbsp;<form:errors path="orgnztDc" /></td>
  </tr>
</table>
