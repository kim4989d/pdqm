...
<table width="303" border="0" cellspacing="8" cellpadding="0">
     ...
     <tr>
	<td width="40%"class="title_left"><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle">&nbsp;인증서 DN 추출</td>
     </tr>
     <tr>
		...
		<table>
		  <tr>
              ...
              <tr>
	           ...
	           <input type="text" size="13" maxlength="16" name="dn" value='<c:out value="${dn}"/>'>&nbsp;&nbsp;
		       <td><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_left.gif' />" width="8" height="20"></td>
