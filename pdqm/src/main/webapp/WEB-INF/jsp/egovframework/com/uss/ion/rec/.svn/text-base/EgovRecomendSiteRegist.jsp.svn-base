...
<!--  상단타이틀 -->
<form:form commandName="recomendSiteManageVO" action="${pageContext.request.contextPath}/uss/ion/rec/RecomendSiteInfoRegist.do" method="post" >
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="추천사이트정보등록테이블">
  ...
  <tr>
    ...
    <td>
      ...
      <a href="#LINK" onClick="fn_egov_NormalCalendar(recomendSiteManageVO,'', recomendSiteManageVO.confmDe); return false;">
      <img name="calendarImg" src="<c:url value='/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />"  align="middle" style="border:0px" alt="승인일달력" title="승인일달력">
      </a>
