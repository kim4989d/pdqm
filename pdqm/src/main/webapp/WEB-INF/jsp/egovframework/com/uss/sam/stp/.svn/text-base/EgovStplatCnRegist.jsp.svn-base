...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="left" alt="">&nbsp;약관내용 등록</h1></td>
 </tr>
</table>
...
<tr>
  ...
  <td>&nbsp;</td>  
  <td><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_left.gif' />" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
  <td class="btnBackground" nowrap><a href="<c:url value='/uss/sam/stp/StplatListInqire.do' />">목록</a></td>  
  <td><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_right.gif' />" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>     
