...
<%
/**
 * @Class Name : SelectAccessView.java
 * @Description : 접속통계
...
function fncSearch(){
    ...
    //document.listForm.action = "<c:url value='/admin/stats/selectAccessCount.do'/>";
...
function fnOpen() {
	...
	oReport.rptname ="./pdqm/admin/selectAccessCount";
...
<%@ include file="/html/pdqm/admin/include/menu.jsp" %>
	...
	<!-- content start -->
	<div class="title">
		<div class="locationMap">통계 > 접속통계</div>
		<h2>접속통계</h2>
	</div>
