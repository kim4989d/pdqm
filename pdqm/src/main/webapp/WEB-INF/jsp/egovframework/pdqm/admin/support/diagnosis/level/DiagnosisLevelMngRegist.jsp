...
function fn_insert(){
	if (fn_fomrValidate()){
		if(confirm("<spring:message code='common.save.msg'/>")){
			...
			document.form.action = "<c:url value='/support/diagnosis/insertDiagnosisLevelMng.do' />";
...
function fn_fomrValidate(){
	...
	var maxNum = Number(frm.maxNum.value)+1;
			...
			<legend>진단대상등록/수정/삭제</legend>
				<table class="vblType1" summary="진단대상등록/수정/삭제 테이블입니다.">
					...
					<tr>
						...
						<td>
							<form:input path="sortOrdr" value="${maxNum+1}" cssClass="text" onblur="onlyNum(this)"  cssStyle="width:100px" maxlength="2"  />
						</td>
					</tr>
					<tr>
