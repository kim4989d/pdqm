...
<div id="page">
		...
		<a  
			 href="http://localhost:1935/myapp/mp4:sample.mp4/manifest.f4m"
	...
	flowplayer("player", "<c:url value='/js/pdqm/flowplayer-3.2.7.swf'/>",
		{
			clip: {
				url: 'mp4:sample.mp4',
				provider: 'rtmp'
			...
			plugins: {
				rtmp: {
				url: "<c:url value='/js/pdqm/flowplayer.rtmp-3.2.3.swf'/>",
