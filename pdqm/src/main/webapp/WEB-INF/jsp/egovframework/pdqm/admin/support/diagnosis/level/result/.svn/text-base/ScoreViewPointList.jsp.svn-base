...
<%
/**
 * @Class Name : ScoreViewPointList.jsp
...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/support/diagnosis/level/selectScoreViewPointList.do'/>";
 ...
 * 상세회면 처리 함수
 ******************************************************** */
function fnDetail(dgnssTrgetId,dgnssTrgetNm,upperDgnssTrgetNm){
	...
	varForm.action           = "<c:url value='/support/diagnosis/level/updateScoreViewPointView.do'/>";
		...
		<tbody> 
			<c:forEach items="${resultList}" var="resultList" varStatus="status">
				<tr >
					...
					<td><a href="javascript:fnDetail('${resultList.dgnssTrgetId}','${resultList.dgnssTrgetNm }','${resultList.upperDgnssTrgetNm}'  );" >${resultList.dgnssTrgetNm }</a></td>
