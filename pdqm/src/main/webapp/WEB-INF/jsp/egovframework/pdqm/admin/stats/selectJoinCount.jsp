...
<%
/**
 * @Class Name : SelectJoinView.java
 * @Description : 가입통계
...
function fncSearch(){
    ...
    //document.listForm.action = "<c:url value='/admin/stats/selectJoinCount.do'/>";
...
function fnOpen() {
	...
	oReport.rptname ="./pdqm/admin/selectJoinCount";	// 리포트파일명
...
<%@ include file="/html/pdqm/admin/include/menu.jsp" %>
	...
	<!-- content start -->
	<div class="title">
		<div class="locationMap">통계 > 가입통계</div>
		<h2>가입통계</h2>
	</div>
			...
			<table class="vblType1" summary="검색조건 테이블입니다.">
				...
				<tr>
					...
					<td>
				      ...
				      <form:input path="dateFrom" cssClass="text" cssStyle="width:45px" onClick="fnYearMonthCalendar(document.listForm, document.listForm.dateFrom);" />
				      <img src="<c:url value='/images/egovframework/pdqm/admin/calendar.gif' />"
						...
						~
					  <form:input path="dateTo" cssClass="text" cssStyle="width:45px" onClick="fnYearMonthCalendar(document.listForm, document.listForm.dateTo);" />
				      <img src="<c:url value='/images/egovframework/pdqm/admin/calendar.gif' />"
