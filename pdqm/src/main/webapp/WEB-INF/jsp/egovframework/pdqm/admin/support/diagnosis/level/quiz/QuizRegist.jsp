...
function fn_insert(){
	if (fn_fomrValidate()){
		if(confirm("<spring:message code='common.save.msg'/>")){
			...
			document.form.action = "<c:url value='/support/diagnosis/level/insertQuiz.do' />";
...
function fn_onload(){
	...
	varForm.searchAnswerTyCode.value  = "T1000";
...
<input type="hidden" name="searchAnswerTyCode" />
...
<!-- contents: Start -->
	<div class="title">
		<div class="locationMap">품질수준 자가진단관리 > 문항 관리 > 문항 등록</div>
		<h2>문항 등록</h2>
	</div>
	...
	<table class="vblType1" summary="설문등록 테이블입니다.">
		...
		<tr>
			...
			<td>
			<form:textarea path="qesitm" cssClass="textarea" rows="3" cols="92" />
			</td>
		</tr>
		<tr>
