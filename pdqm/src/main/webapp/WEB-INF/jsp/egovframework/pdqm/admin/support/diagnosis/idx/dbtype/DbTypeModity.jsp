 ...
 function fn_update(){
	if (fn_fomrValidate()){
		if(confirm("<spring:message code='common.save.msg'/>")){
			document.form.action = "<c:url value='/support/diagnosis/idx/updateIdxDbType.do' />";
	...
	function fn_delete(){
		if(confirm("<spring:message code='common.delete.msg'/>")){
			...
			document.form.action = "<c:url value='/support/diagnosis/idx/deleteIdxDbType.do' />";
		   	document.form.submit();
