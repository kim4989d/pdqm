...
function fn_egov_downFile(atchFileId, fileSn){
	if("Y" != "Y") {
		alert("비회원은 다운로드 할 수 없습니다!");
		return;
	}
	var left = screen.width/2 - 30;
	var top = screen.height/2 - 30;
	window.open("/pdqm/cmm/fms/FileDown.do?atchFileId="+atchFileId+"&fileSn="+fileSn+"","","top="+top+" left="+left+" width=1 height=1");
}
	</script>
</head>
			...
			<ul>
						...
						<table class="conTable2" summary="품질관리수준 자가진단 기본정보 선택 테이블입니다.">
							...
							<tbody>
								<tr>
									...
									<td><a href="http://likms.assembly.go.kr/law/jsp/law/LawThree.jsp?WORK_TYPE=LAW_THREE&LAW_ID=A1730&PROM_NO=10580&PROM_DT=20110412" target="_blank"><img src="<c:url value='/images/pdqm/common/btn/btn_s_original.gif'/>" alt="원문보기" /></a></td>
								</tr>
								<tr>
									<th>국가정보화기본법</th>
									...
									<td><a href="http://likms.assembly.go.kr/law/jsp/law/LawThree.jsp?WORK_TYPE=LAW_THREE&LAW_ID=A0025&PROM_NO=10629&PROM_DT=20110519" target="_blank"><img src="<c:url value='/images/pdqm/common/btn/btn_s_original.gif'/>" alt="원문보기" /></a></td>
								</tr>
							</tbody>
						</table>
					</div>
								...
								<tr>
									...
									<td>
										<c:import url="/cmm/fms/selectFileInfs.do" charEncoding="utf-8">
											<c:param name="param_atchFileId" value="FILE_000000000001381" />
										</c:import>
										<c:import url="/cmm/fms/selectFileInfs.do" charEncoding="utf-8">
											<c:param name="param_atchFileId" value="FILE_000000000001391" />
										</c:import>
									</td>
								</tr>
							</tbody>
						</table>
						<p class="mt_20"><img src="<c:url value='/images/pdqm/front/summary/img_sum2_tab2_1.gif'/>" alt="총칙은 제1조 목적과 제2조 정의로 구성되며, 제3조 공공기관의 데이터베이스 품질관리 계획의 수립, 제4조 공공기관의 데이터베이스 품질 오류신고 접수 및 처리, 제5조 공공기관의 데이터베이스 표준화, 제6조 연계데이터 품질관리, 제7조 품질관리지원센터로 구성됩니다. " /></p>
					</div>
				</li>
				...
				<li><a href="#header" class="sum2_tab3">품질관리 매뉴얼</a>
					<div class="tab_conTxt">
						...
						<p class="mt_10"><img src="<c:url value='/images/pdqm/front/summary/img_sum2_tab3_1.gif'/>" alt="공공기관 데이터베이스 품질관리 지침(11년 7월 4일 제정고시) 1.추진배경: 공공기관 보유 데이터의 개방·공유, 연계·활용을 통한 서비스 확대, 국가정보화를 통해 축적된 데이터의 품질 확보가 필요 2.지침목적(제1조): 국가정보화기본법에 근거하여 공공기관이 정보화 과정에서 생산·유통 또는 활용되는 데이터베이스 품질을 관리하기 위한 세부사항을 규정 3.주요내용: 데이터베이스 품질관리 계획 수립 (제3조), 품질오류 신고 접수 및 처리 (제4조), 데이터베이스 표준화 (제5조), 연계데이터 품질관리 (제6조), 품질관리 지원센터 (제7조) 이러한 지침에 근거하여 품질관리 세부 실행 매뉴얼이 필요하게 되었습니다. 공공기관 데이터베이스 품질관리 매뉴얼 1.총론: 추진배경/목적, 매뉴얼 구성/활용, 데이터 품질관리  이해 2.데이터품질관리: 국가 차원의 데이터  품질관리, 기관 차원의 데이터 품질관리 3.데이터 품질 진단·개선: 데이터 품질 진단 및 개선 절차 정의, 절차 별 세부 수행방안  제시 4.붙임: 관련서식, 용어설명, 지침 조항 별 해설 등" /></p>
						...
						<p class="mt_10"><img src="<c:url value='/images/pdqm/front/summary/img_sum2_tab3_2.gif'/>" alt="국가 차원의 데이터 품질관리는 법과 제도, 지침, 지원인프라를 근간으로 합니다. 기관 차원의 데이터 품질관리 활동은 계획단계 품질관리, 데이터 구축단계 품질관리, 데이터 운영단계 품질관리, 데이터 활용관계 품질관리의 4단계로 구분할 수 있습니다. 이러한 활동은 품질관리 인프라와 품질관리 정책 및 조직이 지원하게 됩니다. 일반국민과 유관기관은 품질오류 신고를 통하여 품질수준을 높이고, 연계기관은 데이터연계, 제공, 활용을 하고 있습니다. 이러한 체계로 국가와 기관의 비전과 목표에 도달할 수 있습니다." /></p>
						...
						<p class="mt_10"><img src="<c:url value='/images/pdqm/front/summary/img_sum2_tab3_3.gif'/>" alt="데이터 품질 진단 및 개선: 1.진단정의, 2.품질진단, 3.결과분석, 4.개선계획, 5.개선실시, 6.통제. 단계를 거쳐 데이터 품질관리를 계획하고 데이터구축, 데이터베이스 생성과 저장, 활용이 가능합니다." /></p>
						...
						<table class="conTable1" summary=" 목차, 주요내용 입니다.">
							...
							<tbody>
								<tr>
									<th rowspan="9" class="br_r">① 총 론<br /><a href="javascript:fn_egov_downFile('FILE_000000000001521','0')"><img src="<c:url value='/images/pdqm/common/btn/btn_s_download.gif'/>" alt="pdf 다운로드" /></a></th>
								...
								<tr>
									<th rowspan="7" class="br_r">② 데이터 품질관리<br /><a href="javascript:fn_egov_downFile('FILE_000000000001522','0')"><img src="<c:url value='/images/pdqm/common/btn/btn_s_download.gif'/>" alt="pdf 다운로드" /></a></th>
								...
								<tr>
									<th rowspan="8" class="br_r">③ 데이터 품질<br />진단 및 개선<br /><a href="javascript:fn_egov_downFile('FILE_000000000001523','0')"><img src="<c:url value='/images/pdqm/common/btn/btn_s_download.gif'/>" alt="pdf 다운로드" /></a></th>
									<td class="br_r">1. 개요</td>
						...
						<table class="conTable2" summary="첨부파일 테이블입니다.">
							...
							<tr>
								...
								<td>
									<c:import url="/cmm/fms/selectFileInfs.do" charEncoding="utf-8">
										<c:param name="param_atchFileId" value="FILE_000000000001524" />
									</c:import>
									<c:import url="/cmm/fms/selectFileInfs.do" charEncoding="utf-8">
										<c:param name="param_atchFileId" value="FILE_000000000001525" />
									</c:import>
									<c:import url="/cmm/fms/selectFileInfs.do" charEncoding="utf-8">
										<c:param name="param_atchFileId" value="FILE_000000000001528" />
									</c:import>
									<c:import url="/cmm/fms/selectFileInfs.do" charEncoding="utf-8">
										<c:param name="param_atchFileId" value="FILE_000000000001527" />
									</c:import>
									<c:import url="/cmm/fms/selectFileInfs.do" charEncoding="utf-8">
										<c:param name="param_atchFileId" value="FILE_000000000001529" />
									</c:import>
									<c:import url="/cmm/fms/selectFileInfs.do" charEncoding="utf-8">
										<c:param name="param_atchFileId" value="FILE_000000000001530" />
									</c:import>
