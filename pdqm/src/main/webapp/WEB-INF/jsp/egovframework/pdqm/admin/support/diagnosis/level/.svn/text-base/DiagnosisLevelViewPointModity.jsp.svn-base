...
<%
/**
 * @Class Name : DiagnosisLevelViewPointModity.jsp
 ...
 function fn_update(){
		if (fn_fomrValidate()){
			if(confirm("<spring:message code='common.update.msg'/>")){
				...
				document.form.action = "<c:url value='/support/diagnosis/updateDiagnosisLevelViewPoint.do' />";
	...
	function fn_delete(){
		if(confirm("<spring:message code='common.delete.msg'/>")){
			document.form.target  = "_self";
			document.form.action = "<c:url value='/support/diagnosis/deleteDiagnosisLevelViewPoint.do' />";
		   	document.form.submit();
...
<input type="hidden" name="viewDgnssTrgetId" value="${diagnosisLevelMng.upperDgnssTrgetId }" />
...
<!-- contents: Start -->
	...
	<table class="vblType1" summary="진단대상 항목 테이블입니다.">
		...
		<tr>
			<th>진단대상명</th>
			<td><form:input  path="upperDgnssTrgetNm" cssClass="readonly" cssStyle="width:200px" disabled="true" /></td>
		</tr>
	</table>
			...
			<fieldset>
				...
				<table class="vblType1" summary="진단관점 수정/삭제 테이블입니다.">
					...
					<tr>
						...
						<td>
							<form:input  path="dgnssTrgetNm" id="write1" cssClass="text" cssStyle="width:300px" maxlength="13" />
