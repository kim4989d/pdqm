...
public class DiagnosisLevelMngVO implements Serializable {
    
	/** 상태구분 */
    private String searchSttusCode = "";
	
	/** 진단대상명 */
    private String searchTrgetNm = "";
	...
	public String getSearchTrgetNm() {
		return searchTrgetNm;
	}

	public void setSearchTrgetNm(String searchTrgetNm) {
		this.searchTrgetNm = searchTrgetNm;
	}
