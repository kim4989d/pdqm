...
public class BoardVO extends Board implements Serializable {
    ...
    /** khyoon 2011.12.14 검색 게시판ID : 뉴스레터 콘텐츠 관리용  */
    ...
    /** khyoon 파일확장자명 2011.10.24 */
    private String fileExtsn = "";
    
    /** 게시물 분류가능 여부 */
    private String nttClPosblAt = "N";
    
    /** khyoon 분류 검색조건 2011.11.11 */
    private String searchNttClCode = "";
    
    /** khyoon ACTION명 2011.11.15 */
    private String act = "";
	...
	public String getSearchNttClCode() {
		return searchNttClCode;
	}

	public void setSearchNttClCode(String searchNttClCode) {
		this.searchNttClCode = searchNttClCode;
	}
