...
public class BBSManageDAO extends EgovComAbstractDAO {
    ...
    // khyoon 2011.11.24 FOR DEBUG : 묻고답하기 게시판 오류 관계로 강제로 주석 해제
    ...
    return (Long)getSqlMapClientTemplate().queryForObject("BBSManageDAO.selectNewsletterTargetListCnt"); 
    }
	...
	return list("BBSManageDAO.selectNewsletterTargetList",null);
    }    
    ...
    /**
     * 게시판에 대한 최근 게시물 ID를 구한다.
     * khyoon 2011.11.14
     * @param boardVO
     * @return
     * @throws Exception
     */
    public long selectRecentlyNttId(BoardVO boardVO) throws Exception {
	return (Long)getSqlMapClientTemplate().queryForObject("BBSManageDAO.selectRecentlyNttId", boardVO);
    }    

    /**
     * 게시물에 대한 이전 NTT_NO를 구한다.
     * khyoon 2011.11.21
     * @param boardVO
     * @return
     * @throws Exception
     */
    public long selectPreviousNttNo(BoardVO boardVO) throws Exception {
   	return (Long)getSqlMapClientTemplate().queryForObject("BBSManageDAO.selectPreviousNttNo", boardVO);
    }    

    /**
     * 게시물에 대한 다음 NTT_NO를 구한다.
     * khyoon 2011.11.21
     * @param boardVO
     * @return
     * @throws Exception
     */
    public long selectNextNttNo(BoardVO boardVO) throws Exception {
   	return (Long)getSqlMapClientTemplate().queryForObject("BBSManageDAO.selectNextNttNo", boardVO);
    }    
    
    /**
     * 게시물에 대한 이전 SORT_ORDR를 구한다.
     * khyoon 2011.11.21
     * @param boardVO
     * @return
     * @throws Exception
     */
    public long selectPreviousSortOrdr(BoardVO boardVO) throws Exception {
   	return (Long)getSqlMapClientTemplate().queryForObject("BBSManageDAO.selectPreviousSortOrdr", boardVO);
    }    

    /**
     * 게시물에 대한 다음 SORT_ORDR를 구한다.
     * khyoon 2011.11.21
     * @param boardVO
     * @return
     * @throws Exception
     */
    public long selectNextSortOrdr(BoardVO boardVO) throws Exception {
   	return (Long)getSqlMapClientTemplate().queryForObject("BBSManageDAO.selectNextSortOrdr", boardVO);
    }    
    
    /**
     * 게시물에 대한 이전/다음 게시물 ID를 구한다.
     * khyoon 2011.11.21
     * @param boardVO
     * @return
     * @throws Exception
     */
    public long selectNttId(BoardVO boardVO) throws Exception {
   	return (Long)getSqlMapClientTemplate().queryForObject("BBSManageDAO.selectNttId", boardVO);
    }    
