...
public class BoardMasterVO extends BoardMaster implements Serializable {
	...
	// khyoon 게시물분류코드ID명 추가 2011.10.26
    private String nttClCodeIdNm = ""; 
    
    public String getNttClCodeIdNm() {
		return nttClCodeIdNm;
	}

	public void setNttClCodeIdNm(String nttClCodeIdNm) {
		this.nttClCodeIdNm = nttClCodeIdNm;
	}
