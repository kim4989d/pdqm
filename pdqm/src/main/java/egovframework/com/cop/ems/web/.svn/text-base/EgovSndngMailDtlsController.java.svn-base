...
//egovframework/pdqm/admin/contents/newsletter/EmailDispatchHist 로 경로변경. -sey 2011.11.28
        return "egovframework/pdqm/admin/contents/newsletter/EmailDispatchHist";
	}
