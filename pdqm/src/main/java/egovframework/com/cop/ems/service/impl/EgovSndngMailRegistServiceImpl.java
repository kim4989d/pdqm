...
import egovframework.com.cop.ems.service.SndngMailRegistThread;
...
public class EgovSndngMailRegistServiceImpl extends AbstractServiceImpl implements
    ...
    // khyoon 2011.12.13 뉴스레터 대량발송 비동기 처리
    private SndngMailRegistThread sndngMailRegistThread;
    
    public void insertSndngMailByThread(SndngMailVO vo) throws Exception {
    	sndngMailRegistThread = new SndngMailRegistThread(vo, sndngMailRegistDAO, egovMailMsgIdGnrService, egovSndngMailService);
    	sndngMailRegistThread.start();
    }
    //~khyoon
	 ...
	 * @exception Exception
	 */
    public boolean insertSndngMailPassword(SndngMailVO vo) throws Exception {
