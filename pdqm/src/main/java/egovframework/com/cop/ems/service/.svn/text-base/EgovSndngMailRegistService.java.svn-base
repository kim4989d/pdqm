 ...
 *  2011.12.13	윤경한	  메일발송 비동기 처리 메소드 추가
 *  </pre>
 */
public interface EgovSndngMailRegistService {
	 ...
	 * @exception Exception
	 */	
	void insertSndngMailByThread(SndngMailVO vo) throws Exception;
	 ...
	 * @exception Exception
	 */
	boolean insertSndngMailPassword(SndngMailVO vo) throws Exception;
