...
public class FaqManageDefaultVO implements Serializable {
    ...
    private String searchFaqCategory = "";        
	...
	public String getSearchFaqCategory() {
		return searchFaqCategory;
	}

	public void setSearchFaqCategory(String searchFaqCategory) {
		this.searchFaqCategory = searchFaqCategory;
	}
