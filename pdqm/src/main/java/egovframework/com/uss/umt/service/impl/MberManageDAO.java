...
public class MberManageDAO extends EgovComAbstractDAO{
    ...
    public void updateMber(MberManageVO mberManageVO){
        update("mberManageDAO.updateMber_Admin",mberManageVO);
    }

    public void mberSelectUpdt(MberManageVO mberManageVO){
        update("mberManageDAO.mberSelectUpdt",mberManageVO);
    }
    
    
    public void updateMberGrp(String delId, String mberGrp){
    	
    	MberManageVO mberManageVO = new MberManageVO();
    	mberManageVO.setUniqId(delId);
    	mberManageVO.setMberGrp(mberGrp);
    	update("mberManageDAO.updateMberGrp",mberManageVO );
    }
    
    public void updateMberQuit(String uniqId){
    	
    	MberManageVO mberManageVO = new MberManageVO();
    	mberManageVO.setUniqId(uniqId);
    	update("mberManageDAO.updateBbsUseAt",mberManageVO );
    	update("mberManageDAO.updateMberSttus",mberManageVO );
    }
    ...
    public MberManageVO selectEmail(MberManageVO mberManageVO){
        return (MberManageVO)selectByPk("mberManageDAO.selectEmail", mberManageVO);
    }    
