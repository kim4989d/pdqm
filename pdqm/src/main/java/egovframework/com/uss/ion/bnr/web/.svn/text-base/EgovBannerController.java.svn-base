...
public class EgovBannerController {
	 ...
	 * @throws Exception
	 */
    @IncludedInfo(name="팝업존/서비스관리", order = 740 ,gid = 50)
	...
	public String selectBannerList(@ModelAttribute("bannerVO") BannerVO bannerVO,
        ...
        vo.setCodeId("COM202");
        List bannerType_result = cmmUseService.selectCmmCodeDetail(vo);
        model.addAttribute("bannerType_result", bannerType_result);//배너구분코드목록
