...
public class FileManageDAO extends EgovComAbstractDAO {
    ...
    /**
     * khyoon 파일 다운로드횟수를 업데이트 한다. 2011.10.31
     *  
     * @param fvo
     * @throws Exception
     */    
    public void updateFileDownCnt(FileVO fvo) throws Exception {
	insert("FileManageDAO.updateFileDownCnt", fvo);
    }
    
    /**
     * khyoon 게시물별 첫번째 첨부파일 확장자 가져오기. 2011.11.14
     *  
     * @param fvo
     * @throws Exception
     */    
    public String selectFirstFileExtsn(FileVO fvo) throws Exception {
    	return (String)getSqlMapClientTemplate().queryForObject("FileManageDAO.getFirstFileExtsn", fvo);
    }
    ...
    /**
     * khyoon 파일 다운로드횟수에 대한 최대값을 구한다. 2011.10.31
     *  
     * @param fvo
     * @return 
     * @throws Exception
     */    
    public int getMaxDownloadCnt(FileVO fvo) throws Exception {
   	return (Integer)getSqlMapClientTemplate().queryForObject("FileManageDAO.getMaxDownloadCnt", fvo);
    }
