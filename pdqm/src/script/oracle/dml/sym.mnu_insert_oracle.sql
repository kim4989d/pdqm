...
INSERT INTO COMTECOPSEQ ( TABLE_NAME, NEXT_ID ) VALUES ('ROLE_ID', 1);
...
INSERT INTO COMTCZIP(ZIP, SN, CTPRVN_NM, SIGNGU_NM, EMD_NM, LI_BULD_NM, LNBR_DONG_HO, FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('135806', 1, '서울', '강남구', '개포1동', '경남아파트', '', SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
...
INSERT INTO COMTCCMMNDETAILCODE(CODE_ID, CODE, CODE_NM, CODE_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('COM050', '01', '수신', '수신', 'Y',SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
INSERT INTO COMTCCMMNDETAILCODE(CODE_ID, CODE, CODE_NM, CODE_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('COM050', '02', '참조', '참조', 'Y',SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
...
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovQnaAnswerListInqire', '/uss/olh/qna/', 'QnA답변목록조회', 'QnA관리', '/uss/olh/qnm/QnaAnswerListInqire.do');
...
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovSysHistList', '/sym/log/', '시스템이력조회', '시스템이력조회', '/sym/log/SelectSysHistoryList.do');
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovSysLogList', '/sym/log/', '시스템로그조회', '시스템로그조회', '/sym/log/SelectSysLogList.do');
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovTemplateList', '/cop/com/', '템플릿 목록 조회', '템플릿 목록 조회', '/cop/com/selectTemplateInfs.do');
...
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovTrsmrcvLogList', '/sym/log/', '송수신로그조회', '송수신로그조회', '/sym/log/SelectTrsmrcvLogList.do');
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovUserDelete', '/uss/umt/user/', '업무사용자 삭제', '사용자정보삭제후 목록조회 화면으로 이동한다.', '/uss/umt/user/EgovUserDelete.do');
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovUserInsert', '/uss/umt/user/', '업무사용자 등록', '사용자등록처리후 목록화면으로 이동한다.', '/uss/umt/user/EgovUserInsert.do');
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovUserInsertView', '/uss/umt/user/', '업무사용자 등록화면 조회', '사용자등록화면으로 이동한다.', '/uss/umt/user/EgovUserInsertView.do');
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovUserLogList', '/sym/log/', '사용자로그조회', '사용자로그조회', '/sym/log/SelectUserLogList.do');
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovUserManage', '/uss/umt/user/', '업무사용자 관리', '사용자목록을 조회한다. (pageing)', '/uss/umt/user/EgovUserManage.do');
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovUserPasswordUpdt', '/uss/umt/user/', '업무사용자 암호 수정', '업무사용자 암호 수정처리 후 화면 이동', '/uss/umt/user/EgovUserPasswordUpdt.do');
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovUserPasswordUpdtView', '/uss/umt/user/', '업무사용자 암호수정화면 이동', '업무사용자 암호 수정 화면 이동', '/uss/umt/user/EgovUserPasswordUpdtView.do');
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovUserSelectUpdt', '/uss/umt/user/', '업무사용자 수정', '사용자정보 수정후 목록조회 화면으로 이동한다.', '/uss/umt/user/EgovUserSelectUpdt.do');
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovUserSelectUpdtView', '/uss/umt/user/', '업무사용자 상세조회', '사용자정보 수정을 위해 사용자정보를 상세조회한다.', '/uss/umt/user/EgovUserSelectUpdtView.do');
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovUserStats', '/sts/', '사용자통계', '사용자통계', '/sts/selectUserStats.do');
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('EgovWebLogList', '/sym/log/', '웹로그조회', '웹로그조회', '/sym/log/SelectWebLogList.do');
...
INSERT INTO COMTNPROGRMLIST(PROGRM_FILE_NM,PROGRM_STRE_PATH,PROGRM_KOREAN_NM,PROGRM_DC,URL) VALUES('selectBoardList', '/cop/bbs/', '자료실 예시', '자료실', '/cop/bbs/selectBoardList.do?bbsId=BBSMSTR_000000000061');
...
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(5050200,'외부인사정보 조회',5050000,2,'외부인사정보조회', '/', '/', 'EgovTnextrlHrInfo');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(5060000,'게시판 예시',5000000,6,'구현된 자료실 예제', '/', '/', 'dir');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(5060100,'사진첩',5060000,1,'사진첩 예시', '/', '/', 'EgovBoardExamplePicture');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(5060200,'방명록',5060000,2,'방명록 예시', '/', '/', 'EgovBoardExampleGuest');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(5060310,'유효게시판',5060000,3,'유효게시판 예시', '/', '/', 'EgovBoardExampleValidity');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(5060400,'익명게시판',5060000,4,'익명게시판 예시', '/', '/', 'EgovBoardExampleAnonymous');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(5060500,'자료실',5060000,5,'자료실 예시', '/', '/', 'EgovBoardExampleData');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(5070000,'커뮤니티/동호회 뷰페이지',5000000,7,'커뮤니티/동호회 뷰페이지', '/', '/', 'EgovCmmntynClubView');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(5080000,'일정관리',5000000,8,'일정관리', '/', '/', 'dir');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(5080100,'부서일정관리',5080000,1,'부서일정관리', '/', '/', 'EgovDeptSchdulManageList');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(5080200,'일정관리',5080000,2,'', '/', '/', 'EgovIndvdlSchdulManageList');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(5080300,'전체일정',5080000,3,'전체일정', '/', '/', 'EgovAllSchdulManageList');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(5080400,'일지관리',5080000,4,'일지관리', '/', '/', 'EgovDiaryManageList');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(6000000,'통계/리포팅',0,6,'통계/리포팅', '/', '/', 'dir');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(6010000,'게시물통계',6000000,1,'게시물통계', '/', '/', 'EgovBbsStats');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(6020000,'사용자통계',6000000,2,'사용자통계', '/', '/', 'EgovUserStats');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(6030000,'화면통계',6000000,3,'화면통계', '/', '/', 'EgovScrinStats');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(6040000,'접속통계',6000000,4,'접속통계', '/', '/', 'EgovConectStats');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(7000000,'전자우편연계',0,7,'전자우편연계', '/', '/', 'dir');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(7010000,'발송메일내역',7000000,1,'발송메일내역', '/', '/', 'EgovMailDtls');
INSERT INTO COMTNMENUINFO(MENU_NO,MENU_NM,UPPER_MENU_NO,MENU_ORDR,MENU_DC,RELATE_IMAGE_PATH,RELATE_IMAGE_NM,PROGRM_FILE_NM) VALUES(7020000,'발송메일등록',7000000,2,'발송메일등록', '/', '/', 'EgovMailRegist');
